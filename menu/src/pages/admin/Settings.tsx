    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} noValidate className="bg-surface rounded-xl border border-line p-6 space-y-6">

            <div className="flex items-center space-x-3 bg-elevated p-4 rounded-xl border border-line">
              <input
                type="checkbox"
                id="isOpen"
              ...
              <div className="flex flex-col">
                <label htmlFor="isOpen" className="text-sm font-bold text-content cursor-pointer">
                  Restaurante Aberto?
                </label>
                <span className="text-xs text-faint">Permite que clientes façam pedidos no cardápio digital.</span>
              </div>
            </div>
            ...
            <p className="text-xs text-faint font-medium -mt-4">
              Seu cardápio ficará disponível em: <span className="text-accent">{menuUrl}</span>
            </p>
